...
class Sonar:
    ...
    def stopSymphony(self):
        self.setRGBMode(1)
        self.setBreathCycle(1,0, 0)
        self.setBreathCycle(1,1, 0)
        self.setBreathCycle(1,2, 0)
        self.setBreathCycle(2,0, 0)
        self.setBreathCycle(2,1, 0)
        self.setBreathCycle(2,2, 0)
